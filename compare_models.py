...
# 0.5 dropout
model, history = cocomodels.lstm_complex(X, y_words, y_categories, checkpointdir, vocab_size = vocab_size, batch_size=batch_size, epochs=epochs, dropout=0.5, logfile="compare_dropout5.csv")
print(history.history)
